...
class OrderApi
{
     ...
     */
    public function attach($id, $file = null)
    {
        list($response) = $this->attachWithHttpInfo($id, $file);
        return $response;
    }
     ...
     */
    public function attachWithHttpInfo($id, $file = null)
    {
        $returnType = '\Swagger\Client\Model\ResponseWrapperDocumentArchive';
        $request = $this->attachRequest($id, $file);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function attachAsync($id, $file = null)
    {
        return $this->attachAsyncWithHttpInfo($id, $file)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function attachAsyncWithHttpInfo($id, $file = null)
    {
        $returnType = '\Swagger\Client\Model\ResponseWrapperDocumentArchive';
        $request = $this->attachRequest($id, $file);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function attachRequest($id, $file = null)
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \Swagger\Client\Model\ResponseWrapperInvoice
     */
    public function invoiceMultipleOrders($id, $invoice_date)
    {
        list($response) = $this->invoiceMultipleOrdersWithHttpInfo($id, $invoice_date);
        return $response;
    }
     ...
     * @return array of \Swagger\Client\Model\ResponseWrapperInvoice, HTTP status code, HTTP response headers (array of strings)
     */
    public function invoiceMultipleOrdersWithHttpInfo($id, $invoice_date)
    {
        $returnType = '\Swagger\Client\Model\ResponseWrapperInvoice';
        $request = $this->invoiceMultipleOrdersRequest($id, $invoice_date);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function invoiceMultipleOrdersAsync($id, $invoice_date)
    {
        return $this->invoiceMultipleOrdersAsyncWithHttpInfo($id, $invoice_date)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function invoiceMultipleOrdersAsyncWithHttpInfo($id, $invoice_date)
    {
        $returnType = '\Swagger\Client\Model\ResponseWrapperInvoice';
        $request = $this->invoiceMultipleOrdersRequest($id, $invoice_date);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function invoiceMultipleOrdersRequest($id, $invoice_date)
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
