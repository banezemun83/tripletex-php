...
class TimesheetentryApi
{
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\ResponseWrapperDouble
     */
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\ResponseWrapperDouble, HTTP status code, HTTP response headers (array of strings)
     */
    public function getTotalHoursWithHttpInfo($employee_id = null, $start_date = null, $end_date = null, $fields = null)
    {
        $returnType = '\Swagger\Client\Model\ResponseWrapperDouble';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\ResponseWrapperDouble',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
