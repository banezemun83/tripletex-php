...
class SalarytypeApi
{
     ...
     */
    public function search($id = null, $number = null, $name = null, $description = null, $show_in_timesheet = null, $from = null, $count = null, $sorting = null, $fields = null)
    {
        list($response) = $this->searchWithHttpInfo($id, $number, $name, $description, $show_in_timesheet, $from, $count, $sorting, $fields);
        return $response;
    }
     ...
     */
    public function searchWithHttpInfo($id = null, $number = null, $name = null, $description = null, $show_in_timesheet = null, $from = null, $count = null, $sorting = null, $fields = null)
    {
        $returnType = '\Swagger\Client\Model\ListResponseSalaryType';
        $request = $this->searchRequest($id, $number, $name, $description, $show_in_timesheet, $from, $count, $sorting, $fields);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function searchAsync($id = null, $number = null, $name = null, $description = null, $show_in_timesheet = null, $from = null, $count = null, $sorting = null, $fields = null)
    {
        return $this->searchAsyncWithHttpInfo($id, $number, $name, $description, $show_in_timesheet, $from, $count, $sorting, $fields)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function searchAsyncWithHttpInfo($id = null, $number = null, $name = null, $description = null, $show_in_timesheet = null, $from = null, $count = null, $sorting = null, $fields = null)
    {
        $returnType = '\Swagger\Client\Model\ListResponseSalaryType';
        $request = $this->searchRequest($id, $number, $name, $description, $show_in_timesheet, $from, $count, $sorting, $fields);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function searchRequest($id = null, $number = null, $name = null, $description = null, $show_in_timesheet = null, $from = null, $count = null, $sorting = null, $fields = null)
    {
