...
class BankstatementApi
{
     ...
     * @return \Swagger\Client\Model\ResponseWrapperBankStatement
     */
    public function importBankStatement($bank_id, $account_id, $from_date, $to_date, $file_format, $file = null)
    {
        list($response) = $this->importBankStatementWithHttpInfo($bank_id, $account_id, $from_date, $to_date, $file_format, $file);
        return $response;
    }
     ...
     * @return array of \Swagger\Client\Model\ResponseWrapperBankStatement, HTTP status code, HTTP response headers (array of strings)
     */
    public function importBankStatementWithHttpInfo($bank_id, $account_id, $from_date, $to_date, $file_format, $file = null)
    {
        $returnType = '\Swagger\Client\Model\ResponseWrapperBankStatement';
        $request = $this->importBankStatementRequest($bank_id, $account_id, $from_date, $to_date, $file_format, $file);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function importBankStatementAsync($bank_id, $account_id, $from_date, $to_date, $file_format, $file = null)
    {
        return $this->importBankStatementAsyncWithHttpInfo($bank_id, $account_id, $from_date, $to_date, $file_format, $file)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function importBankStatementAsyncWithHttpInfo($bank_id, $account_id, $from_date, $to_date, $file_format, $file = null)
    {
        $returnType = '\Swagger\Client\Model\ResponseWrapperBankStatement';
        $request = $this->importBankStatementRequest($bank_id, $account_id, $from_date, $to_date, $file_format, $file);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function importBankStatementRequest($bank_id, $account_id, $from_date, $to_date, $file_format, $file = null)
    {
