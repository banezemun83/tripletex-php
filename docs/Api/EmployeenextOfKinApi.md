...
# **get**
> \Swagger\Client\Model\ResponseWrapperNextOfKin get($id, $fields)
...
# **post**
> \Swagger\Client\Model\ResponseWrapperNextOfKin post($body)
...
# **put**
> \Swagger\Client\Model\ResponseWrapperNextOfKin put($id, $body)
...
# **search**
> \Swagger\Client\Model\ListResponseNextOfKin search($employee_id, $from, $count, $sorting, $fields)
