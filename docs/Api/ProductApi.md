...
# **get**
> \Swagger\Client\Model\ResponseWrapperProduct get($id, $fields)
...
# **post**
> \Swagger\Client\Model\ResponseWrapperProduct post($body)
...
# **postList**
> \Swagger\Client\Model\ListResponseProduct postList($body)
...
# **put**
> \Swagger\Client\Model\ResponseWrapperProduct put($id, $body)
...
# **putList**
> \Swagger\Client\Model\ListResponseProduct putList($body)
