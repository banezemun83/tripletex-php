...
# **get**
> \Swagger\Client\Model\ResponseWrapperPassenger get($id, $fields)
...
# **post**
> \Swagger\Client\Model\ResponseWrapperPassenger post($body)
...
# **put**
> \Swagger\Client\Model\ResponseWrapperPassenger put($id, $body)
...
# **search**
> \Swagger\Client\Model\ListResponsePassenger search($mileage_allowance, $name, $from, $count, $sorting, $fields)
