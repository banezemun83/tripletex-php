...
# **get**
> \Swagger\Client\Model\ResponseWrapperCompany get($id, $fields)
...
# **getDivisions**
> \Swagger\Client\Model\ListResponseCompany getDivisions($from, $count, $sorting, $fields)
...
# **getWithLoginAccess**
> \Swagger\Client\Model\ListResponseCompany getWithLoginAccess($from, $count, $sorting, $fields)
...
# **put**
> \Swagger\Client\Model\ResponseWrapperCompany put($body)
