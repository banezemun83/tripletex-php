...
# **get**
> \Swagger\Client\Model\ResponseWrapperReminder get($id, $fields)
...
# **search**
> \Swagger\Client\Model\ListResponseReminder search($date_from, $date_to, $id, $term_of_payment_to, $term_of_payment_from, $invoice_id, $customer_id, $from, $count, $sorting, $fields)
