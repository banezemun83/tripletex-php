...
# **get**
> \Swagger\Client\Model\ResponseWrapperCustomer get($id, $fields)
...
# **post**
> \Swagger\Client\Model\ResponseWrapperCustomer post($body)
...
# **postList**
> \Swagger\Client\Model\ListResponseCustomer postList($body)
...
# **put**
> \Swagger\Client\Model\ResponseWrapperCustomer put($id, $body)
...
# **putList**
> \Swagger\Client\Model\ListResponseCustomer putList($body)
...
# **search**
> \Swagger\Client\Model\ListResponseCustomer search($id, $customer_account_number, $organization_number, $email, $invoice_email, $is_inactive, $account_manager_id, $from, $count, $sorting, $fields)
