...
# **get**
> \Swagger\Client\Model\ResponseWrapperStandardTime get($id, $fields)
...
# **post**
> \Swagger\Client\Model\ResponseWrapperStandardTime post($body)
...
# **put**
> \Swagger\Client\Model\ResponseWrapperStandardTime put($id, $body)
...
# **search**
> \Swagger\Client\Model\ListResponseStandardTime search($employee_id, $from, $count, $sorting, $fields)
