...
# **get**
> \Swagger\Client\Model\ResponseWrapperProject get($id, $fields)
...
# **getForTimeSheet**
> \Swagger\Client\Model\ListResponseProject getForTimeSheet($employee_id, $date, $from, $count, $sorting, $fields)
...
# **post**
> \Swagger\Client\Model\ResponseWrapperProject post($body)
...
# **postList**
> \Swagger\Client\Model\ListResponseProject postList($body)
...
# **put**
> \Swagger\Client\Model\ResponseWrapperProject put($id, $body)
...
# **putList**
> \Swagger\Client\Model\ListResponseProject putList($body)
...
# **search**
> \Swagger\Client\Model\ListResponseProject search($id, $name, $number, $is_offer, $project_manager_id, $employee_in_project_id, $department_id, $start_date_from, $start_date_to, $end_date_from, $end_date_to, $is_closed, $customer_id, $external_accounts_number, $from, $count, $sorting, $fields)
