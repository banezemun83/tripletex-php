...
# **get**
> \Swagger\Client\Model\ResponseWrapperProjectParticipant get($id, $fields)
...
# **post**
> \Swagger\Client\Model\ResponseWrapperProjectParticipant post($body)
...
# **postList**
> \Swagger\Client\Model\ListResponseProjectParticipant postList($body)
...
# **put**
> \Swagger\Client\Model\ResponseWrapperProjectParticipant put($id, $body)
