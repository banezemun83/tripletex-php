...
# **get**
> \Swagger\Client\Model\ResponseWrapperOrderLine get($id, $fields)
...
# **post**
> \Swagger\Client\Model\ResponseWrapperOrderLine post($body)
...
# **postList**
> \Swagger\Client\Model\ListResponseOrderLine postList($body)
