...
# **hourlistReport**
> \Swagger\Client\Model\ResponseWrapperProjectPeriodHourlyReport hourlistReport($date_from, $date_to, $id, $fields)
...
# **invoiced**
> \Swagger\Client\Model\ResponseWrapperProjectPeriodInvoiced invoiced($date_from, $date_to, $id, $fields)
...
# **invoicingReserve**
> \Swagger\Client\Model\ResponseWrapperProjectPeriodInvoicingReserve invoicingReserve($date_from, $date_to, $id, $fields)
...
# **monthlyStatus**
> \Swagger\Client\Model\ListResponseProjectPeriodMonthlyStatus monthlyStatus($date_from, $date_to, $id, $from, $count, $sorting, $fields)
...
# **overallStatus**
> \Swagger\Client\Model\ResponseWrapperProjectPeriodOverallStatus overallStatus($date_from, $date_to, $id, $fields)
