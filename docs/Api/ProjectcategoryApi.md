...
# **get**
> \Swagger\Client\Model\ResponseWrapperProjectCategory get($id, $fields)
...
# **post**
> \Swagger\Client\Model\ResponseWrapperProjectCategory post($body)
...
# **put**
> \Swagger\Client\Model\ResponseWrapperProjectCategory put($id, $body)
...
# **search**
> \Swagger\Client\Model\ListResponseProjectCategory search($id, $name, $number, $description, $from, $count, $sorting, $fields)
