...
# **get**
> \Swagger\Client\Model\ResponseWrapperProjectControlForm get($id, $fields)
...
# **search**
> \Swagger\Client\Model\ListResponseProjectControlForm search($project_id, $from, $count, $sorting, $fields)
