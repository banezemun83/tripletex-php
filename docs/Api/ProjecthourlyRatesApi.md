...
# **get**
> \Swagger\Client\Model\ResponseWrapperProjectHourlyRate get($id, $fields)
...
# **post**
> \Swagger\Client\Model\ResponseWrapperProjectHourlyRate post($body)
...
# **postList**
> \Swagger\Client\Model\ListResponseProjectHourlyRate postList($body)
...
# **put**
> \Swagger\Client\Model\ResponseWrapperProjectHourlyRate put($id, $body)
...
# **putList**
> \Swagger\Client\Model\ListResponseProjectHourlyRate putList($body)
...
# **search**
> \Swagger\Client\Model\ListResponseProjectHourlyRate search($id, $project_id, $type, $start_date_from, $start_date_to, $show_in_project_order, $from, $count, $sorting, $fields)
