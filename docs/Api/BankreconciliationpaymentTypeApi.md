...
# **get**
> \Swagger\Client\Model\ResponseWrapperBankReconciliationPaymentType get($id, $fields)
...
# **search**
> \Swagger\Client\Model\ListResponseBankReconciliationPaymentType search($id, $description, $from, $count, $sorting, $fields)
