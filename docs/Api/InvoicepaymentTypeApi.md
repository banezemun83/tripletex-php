...
# **get**
> \Swagger\Client\Model\ResponseWrapperPaymentType get($id, $fields)
...
# **search**
> \Swagger\Client\Model\ListResponsePaymentType search($id, $description, $from, $count, $sorting, $fields)
