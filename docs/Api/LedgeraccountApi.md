...
# **get**
> \Swagger\Client\Model\ResponseWrapperAccount get($id, $fields)
...
# **post**
> \Swagger\Client\Model\ResponseWrapperAccount post($body)
...
# **postList**
> \Swagger\Client\Model\ListResponseAccount postList($body)
...
# **put**
> \Swagger\Client\Model\ResponseWrapperAccount put($id, $body)
...
# **putList**
> \Swagger\Client\Model\ListResponseAccount putList($body)
...
# **search**
> \Swagger\Client\Model\ListResponseAccount search($id, $number, $is_bank_account, $is_inactive, $is_applicable_for_supplier_invoice, $from, $count, $sorting, $fields)
