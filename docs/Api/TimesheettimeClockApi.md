...
# **get**
> \Swagger\Client\Model\ResponseWrapperTimeClock get($id, $fields)
...
# **getPresent**
> \Swagger\Client\Model\ResponseWrapperTimeClock getPresent($employee_id, $fields)
...
# **put**
> \Swagger\Client\Model\ResponseWrapperTimeClock put($id, $body)
...
# **search**
> \Swagger\Client\Model\ListResponseTimeClock search($id, $employee_id, $project_id, $activity_id, $date_from, $date_to, $hour_id, $is_running, $from, $count, $sorting, $fields)
...
# **start**
> \Swagger\Client\Model\ResponseWrapperTimeClock start($activity_id, $employee_id, $project_id, $date)
