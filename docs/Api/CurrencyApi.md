...
# **get**
> \Swagger\Client\Model\ResponseWrapperCurrency get($id, $fields)
...
# **getRate**
> \Swagger\Client\Model\ResponseWrapperCurrencyExchangeRate getRate($id, $date, $fields)
...
# **search**
> \Swagger\Client\Model\ListResponseCurrency search($id, $code, $from, $count, $sorting, $fields)
