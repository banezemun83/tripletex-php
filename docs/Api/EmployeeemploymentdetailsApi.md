...
# **get**
> \Swagger\Client\Model\ResponseWrapperEmploymentDetails get($id, $fields)
...
# **post**
> \Swagger\Client\Model\ResponseWrapperEmploymentDetails post($body)
...
# **put**
> \Swagger\Client\Model\ResponseWrapperEmploymentDetails put($id, $body)
...
# **search**
> \Swagger\Client\Model\ListResponseEmploymentDetails search($employment_id, $from, $count, $sorting, $fields)
