...
# **get**
> \Swagger\Client\Model\ResponseWrapperProjectSpecificRate get($id, $fields)
...
# **post**
> \Swagger\Client\Model\ResponseWrapperProjectSpecificRate post($body)
...
# **postList**
> \Swagger\Client\Model\ListResponseProjectSpecificRate postList($body)
...
# **put**
> \Swagger\Client\Model\ResponseWrapperProjectSpecificRate put($id, $body)
...
# **putList**
> \Swagger\Client\Model\ListResponseProjectSpecificRate putList($body)
...
# **search**
> \Swagger\Client\Model\ListResponseProjectSpecificRate search($id, $project_hourly_rate_id, $employee_id, $activity_id, $from, $count, $sorting, $fields)
