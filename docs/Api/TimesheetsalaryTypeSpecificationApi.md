...
# **get**
> \Swagger\Client\Model\ResponseWrapperTimesheetSalaryTypeSpecification get($id, $fields)
...
# **post**
> \Swagger\Client\Model\ResponseWrapperTimesheetSalaryTypeSpecification post($body)
...
# **put**
> \Swagger\Client\Model\ResponseWrapperTimesheetSalaryTypeSpecification put($id, $body)
...
# **search**
> \Swagger\Client\Model\ListResponseTimesheetSalaryTypeSpecification search($date_from, $date_to, $employee_id, $from, $count, $sorting, $fields)
