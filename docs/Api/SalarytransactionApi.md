...
# **get**
> \Swagger\Client\Model\ResponseWrapperSalaryTransaction get($id, $fields)
...
# **post**
> \Swagger\Client\Model\ResponseWrapperSalaryTransaction post($body, $generate_tax_deduction)
