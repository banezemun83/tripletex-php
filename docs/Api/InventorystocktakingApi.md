...
# **get**
> \Swagger\Client\Model\ResponseWrapperStocktaking get($id, $fields)
...
# **post**
> \Swagger\Client\Model\ResponseWrapperStocktaking post($body)
...
# **put**
> \Swagger\Client\Model\ResponseWrapperStocktaking put($id, $body)
...
# **search**
> \Swagger\Client\Model\ListResponseStocktaking search($id, $is_completed, $inventory_id, $from, $count, $sorting, $fields)
