...
# **get**
> \Swagger\Client\Model\ResponseWrapperEmployment get($id, $fields)
...
# **post**
> \Swagger\Client\Model\ResponseWrapperEmployment post($body)
...
# **put**
> \Swagger\Client\Model\ResponseWrapperEmployment put($id, $body)
...
# **search**
> \Swagger\Client\Model\ListResponseEmployment search($employee_id, $from, $count, $sorting, $fields)
