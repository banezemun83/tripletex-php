...
# **get**
> \Swagger\Client\Model\ResponseWrapperSubscription get($id, $fields)
...
# **post**
> \Swagger\Client\Model\ResponseWrapperSubscription post($body)
...
# **put**
> \Swagger\Client\Model\ResponseWrapperSubscription put($id, $body)
...
# **search**
> \Swagger\Client\Model\ListResponseSubscription search($from, $count, $sorting, $fields)
