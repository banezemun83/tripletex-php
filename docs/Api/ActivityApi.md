...
# **get**
> \Swagger\Client\Model\ResponseWrapperActivity get($id, $fields)
...
# **getForTimeSheet**
> \Swagger\Client\Model\ListResponseActivity getForTimeSheet($project_id, $employee_id, $date, $from, $count, $sorting, $fields)
...
# **post**
> \Swagger\Client\Model\ResponseWrapperActivity post($body)
...
# **postList**
> \Swagger\Client\Model\ListResponseActivity postList($body)
...
# **search**
> \Swagger\Client\Model\ListResponseActivity search($id, $name, $number, $description, $is_project_activity, $is_general, $is_chargeable, $is_task, $from, $count, $sorting, $fields)
