...
# **get**
> \Swagger\Client\Model\ResponseWrapperProjectInvoiceDetails get($id, $fields)
...
# **search**
> \Swagger\Client\Model\ListResponseProjectInvoiceDetails search($invoice_date_from, $invoice_date_to, $id, $from, $count, $sorting, $fields)
