...
# **get**
> \Swagger\Client\Model\ResponseWrapperProjectOrderLine get($id, $fields)
...
# **post**
> \Swagger\Client\Model\ResponseWrapperProjectOrderLine post($body)
...
# **postList**
> \Swagger\Client\Model\ListResponseProjectOrderLine postList($body)
...
# **put**
> \Swagger\Client\Model\ResponseWrapperProjectOrderLine put($id, $body)
...
# **search**
> \Swagger\Client\Model\ListResponseProjectOrderLine search($project_id, $from, $count, $sorting, $fields)
