...
# **get**
> \Swagger\Client\Model\ResponseWrapperTravelCostCategory get($id, $fields)
...
# **search**
> \Swagger\Client\Model\ListResponseTravelCostCategory search($id, $description, $is_inactive, $show_on_employee_expenses, $from, $count, $sorting, $fields)
