...
# **get**
> \Swagger\Client\Model\ResponseWrapperLegacyAddress get($id, $fields)
...
[**\Swagger\Client\Model\ResponseWrapperLegacyAddress**](../Model/ResponseWrapperLegacyAddress.md)
...
# **put**
> \Swagger\Client\Model\ResponseWrapperLegacyAddress put($id, $body)
...
$id = 56; // int | Element ID
$body = new \Swagger\Client\Model\LegacyAddress(); // \Swagger\Client\Model\LegacyAddress | Partial object describing what should be updated
...
------------- | ------------- | ------------- | -------------
 **id** | **int**| Element ID |
 **body** | [**\Swagger\Client\Model\LegacyAddress**](../Model/LegacyAddress.md)| Partial object describing what should be updated | [optional]
...
# **put_0**
> \Swagger\Client\Model\ResponseWrapperDeliveryAddress put_0($id, $body)
...
# **search**
> \Swagger\Client\Model\ListResponseLegacyAddress search($id, $address_line1, $address_line2, $postal_code, $city, $name, $from, $count, $sorting, $fields)
...
[**\Swagger\Client\Model\ListResponseLegacyAddress**](../Model/ListResponseLegacyAddress.md)
