...
# **get**
> \Swagger\Client\Model\ResponseWrapperInventory get($id, $fields)
...
# **post**
> \Swagger\Client\Model\ResponseWrapperInventory post($body)
...
# **put**
> \Swagger\Client\Model\ResponseWrapperInventory put($id, $body)
...
# **search**
> \Swagger\Client\Model\ListResponseInventory search($id, $name, $is_main_inventory, $is_inactive, $from, $count, $sorting, $fields)
