...
# **get**
> \Swagger\Client\Model\ResponseWrapperCloseGroup get($id, $fields)
...
# **search**
> \Swagger\Client\Model\ListResponseCloseGroup search($date_from, $date_to, $id, $from, $count, $sorting, $fields)
