...
# **get**
> \Swagger\Client\Model\ResponseWrapperContact get($id, $fields)
...
# **post**
> \Swagger\Client\Model\ResponseWrapperContact post($body)
...
# **put**
> \Swagger\Client\Model\ResponseWrapperContact put($id, $body)
...
# **search**
> \Swagger\Client\Model\ListResponseContact search($id, $first_name, $last_name, $email, $customer_id, $from, $count, $sorting, $fields)
