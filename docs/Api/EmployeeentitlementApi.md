...
# **client**
> \Swagger\Client\Model\ListResponseEntitlement client($employee_id, $customer_id, $from, $count, $sorting, $fields)
...
# **get**
> \Swagger\Client\Model\ResponseWrapperEntitlement get($id, $fields)
...
# **search**
> \Swagger\Client\Model\ListResponseEntitlement search($employee_id, $from, $count, $sorting, $fields)
