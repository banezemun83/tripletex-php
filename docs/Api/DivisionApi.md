...
# **post**
> \Swagger\Client\Model\ResponseWrapperDivision post($body)
...
# **postList**
> \Swagger\Client\Model\ListResponseDivision postList($body)
...
# **put**
> \Swagger\Client\Model\ResponseWrapperDivision put($id, $body)
...
# **putList**
> \Swagger\Client\Model\ListResponseDivision putList($body)
...
# **search**
> \Swagger\Client\Model\ListResponseDivision search($from, $count, $sorting, $fields)
